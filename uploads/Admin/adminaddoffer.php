    ...
    <div id="" class="container-fluid">
        ...
        <div class="row">
            <div class="col-md order-md-1">
                <form action="../Controller/addoffer.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="price">Giảm giá hoặc quà tặng</label>
                        <div class="input-group">
                    ...
                    <div class="d-flex justify-content-lg-around justify-content-center align-items-center">
                        <button class="btn btn-success btn-lg w-25" type="submit">Thêm ưu đãi</button>
